...
# simple pybullet script that models sinusoidal wagging of a pendulum
#  no arguements are passed, urdf file is hardcoded
#
# because pybullet simulations are not real time, this outputs a video
#  to disk. For some reason pybullet's default video codec doesnt work
#  so this was made using Open CV. cv2 enables overlay of torque and time
#  directly on to the video
