...
Suppose you bought a MT6701 board and you wanted to determine its mode setting. **When programming the board be sure to do it at +5V over I2C.** Teensy boards will not work. Use this code with a arduino-based controller:
```
#include <Wire.h>
